...
Uint8 icons[][8] = {
    ...
    {0x05, 0x0A, 0x0C, 0x28, 0x7D, 0xFE, 0x24, 0x48}, /* winged rat */
    {0x7C, 0x92, 0xDA, 0x92, 0xEE, 0x7C, 0x54, 0x00}, /* floating skull */
...
int is_boss_possible() {
  if (monsters_beaten[1] > 0 && monsters_beaten[2] > 0 &&
      monsters_beaten[3] > 0 && monsters_beaten[4] > 0 &&
      monsters_beaten[5] > 0 && current_gen_room.type > 4) {
    return 1;
  }
...
void gen_room() {
  ...
  current_gen_room.monster_type = dice(1, (5 + is_boss_possible()));
